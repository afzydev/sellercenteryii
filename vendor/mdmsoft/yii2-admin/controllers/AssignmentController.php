...
class AssignmentController extends AppController
{
    ...
    public function actionIndex()
    {
        ...
        if ($this->searchClass === null) {
          ...
          //  $dataProvider = $searchModel->search(\Yii::$app->request->getQueryParams(), $this->userClassName);
       // } else {
       //     $class = $this->searchClass;
       //     $searchModel = new $class;
       //     $dataProvider = $searchModel->search(\Yii::$app->request->getQueryParams());
       // }
        if(isset($_GET['Assignment']['email']) && !empty($_GET['Assignment']['email'])){
			$searchModel->email = $_GET['Assignment']['email'];
        }
        if(isset($_GET['Assignment']['firstname']) && !empty($_GET['Assignment']['firstname'])){
                $searchModel->firstname = $_GET['Assignment']['firstname'];
        }
        if(isset($_GET['Assignment']['lastname']) && !empty($_GET['Assignment']['lastname'])){
                $searchModel->lastname = $_GET['Assignment']['lastname'];
        }
        if(isset($_GET['Assignment']['profile']) && !empty($_GET['Assignment']['profile'])){
                $searchModel->profile = $_GET['Assignment']['profile'];
        }
        if(isset($_GET['Assignment']['active'])){
                $searchModel->active = $_GET['Assignment']['active'];
        }
        $dataProvider = $searchModel->search(\Yii::$app->request->getQueryParams(), $this->userClassName);}
